...
class Vehiculos extends React.Component{
  ...
  constructor(props) {
    ...
    componentDidMount(){
      //Imagen 1
      Storage.get('vehiculos/auto.jpg')
        .then(data => {
          this.setState({
            img1: data
          })
      ...
      //Imagen 2
      Storage.get('vehiculos/avion.jpg')
        .then(data => {
          this.setState({
            img2: data
          })
      ...
      //Imagen 3
      Storage.get('vehiculos/bicicleta.jpg')
        .then(data => {
          this.setState({
            img3: data
          })
      ...
      //Imagen 4
      Storage.get('vehiculos/camion.jpg')
        .then(data => {
          this.setState({
            img4: data
          })
      ...
      //Imagen 5
      Storage.get('vehiculos/catapila.jpg')
        .then(data => {
          this.setState({
            img5: data
          })
      ...
      //Imagen 6
      Storage.get('vehiculos/cuatrimoto.jpg')
        .then(data => {
          this.setState({
            img6: data
          })
        ...
        //Imagen 8
        Storage.get('vehiculos/moto.jpg')
          .then(data => {
            this.setState({
              img8: data
            })
        ...
        //Imagen 9
        Storage.get('vehiculos/tractor.jpg')
         .then(data => {
            this.setState({
              img9: data
            })
        ...
        //Imagen 10
        Storage.get('vehiculos/tren.jpg')
         .then(data => {
            this.setState({
              img10: data
            })
